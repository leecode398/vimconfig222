...
function! <SID>Trinity_InitTagList()
    ...
    "---------------------------------
    "  My personal settings (zhendong)
    "---------------------------------
    let g:Tlist_Use_SingleClick=1          "Setting click tag to jump by once, twice by default.
    let g:Tlist_Auto_Update=1
    let g:Tlist_Process_File_Always=1
    let g:Tlist_Auto_Highlight_Tag=1
    let g:Tlist_Auto_Open=0
    let g:Tlist_Close_On_Select=0
    let g:Tlist_GainFocus_On_ToggleOpen=0 "Setting opens the taglist window, enter the focus in the taglist window
    let g:Tlist_Use_Horiz_Window=0        "Setting taglist window to display horizontally.
...
function! <SID>Trinity_InitNERDTree()
    ...
    let g:NERDTreeQuitOnOpen=0             "Setting to close tree when opens a file
    let g:NERDTreeChDirMode=2              "Setting choose currect directory is 'root'
    let g:NERDTreeMinimalUI=1              "Setting do not display 'help'
    let g:NERDTreeDirArrows=1              "Setting directory Arrow 1-Arrow  0-+/-/|
    let g:NERDTreeMouseMode=3              "Setting open while Click once, two by default
